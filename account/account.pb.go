...
type IdentifyTelegramRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *IdentifyTelegramRequest) Reset() {
	*x = IdentifyTelegramRequest{}
	mi := &file_account_account_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *IdentifyTelegramRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IdentifyTelegramRequest) ProtoMessage() {}

func (x *IdentifyTelegramRequest) ProtoReflect() protoreflect.Message {
	mi := &file_account_account_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IdentifyTelegramRequest.ProtoReflect.Descriptor instead.
func (*IdentifyTelegramRequest) Descriptor() ([]byte, []int) {
	return file_account_account_proto_rawDescGZIP(), []int{2}
}

func (x *IdentifyTelegramRequest) GetTgId() int64 {
	if x != nil {
		return x.TgId
	}
	return 0
...
func (x *IdentifyTelegramRequest) GetTgFirstName() string {
	if x != nil {
...
func (x *IdentifyTelegramRequest) GetTgLastName() string {
	if x != nil {
		return x.TgLastName
	}
	return ""
...
func (x *IdentifyTelegramRequest) GetTgUsername() string {
	if x != nil {
		return x.TgUsername
	}
	return ""
...
func (x *IdentifyTelegramRequest) GetTgIsPremium() bool {
	if x != nil {
...
type GetAccountShortRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Uuid          []byte                 `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetAccountShortRequest) Reset() {
	*x = GetAccountShortRequest{}
	mi := &file_account_account_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAccountShortRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAccountShortRequest) ProtoMessage() {}

func (x *GetAccountShortRequest) ProtoReflect() protoreflect.Message {
	mi := &file_account_account_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAccountShortRequest.ProtoReflect.Descriptor instead.
func (*GetAccountShortRequest) Descriptor() ([]byte, []int) {
	return file_account_account_proto_rawDescGZIP(), []int{3}
}

func (x *GetAccountShortRequest) GetUuid() []byte {
	if x != nil {
		return x.Uuid
	}
	return nil
...
var file_account_account_proto_rawDesc = string([]byte{
	...
	0xe5, 0x01, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x75,
	...
	0x68, 0x6f, 0x74, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x74,
	...
	0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x74, 0x0a, 0x0c, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	,
	...
	,
...
var file_account_account_proto_goTypes = []any{
	...
	(*IdentifyTelegramRequest)(nil), // 3: users.IdentifyTelegramRequest
	(*GetAccountShortRequest)(nil),  // 4: users.GetAccountShortRequest
...
var file_account_account_proto_depIdxs = []int32{
	...
	3, // 2: users.Users.IdentifyTelegram:input_type -> users.IdentifyTelegramRequest
	4, // 3: users.Users.GetAccountShort:input_type -> users.GetAccountShortRequest
	1, // 4: users.Users.IdentifyTelegram:output_type -> users.Account
