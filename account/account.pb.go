...
type Profile struct {
	...
	FeedCoins     [][]byte               `protobuf:"bytes,2,rep,name=feed_coins,json=feedCoins,proto3" json:"feed_coins,omitempty"`
...
func (x *Profile) GetFeedCoins() [][]byte {
	if x != nil {
		return x.FeedCoins
	}
	return nil
...
var file_account_account_proto_rawDesc = string([]byte{
	...
	0x20, 0x03, 0x28, 0x0c, 0x52, 0x09, 0x66, 0x65, 0x65, 0x64, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x22,
