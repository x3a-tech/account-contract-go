...
type TryRegistryFromTelegramRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *TryRegistryFromTelegramRequest) Reset() {
	*x = TryRegistryFromTelegramRequest{}
	mi := &file_account_account_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TryRegistryFromTelegramRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TryRegistryFromTelegramRequest) ProtoMessage() {}

func (x *TryRegistryFromTelegramRequest) ProtoReflect() protoreflect.Message {
	mi := &file_account_account_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TryRegistryFromTelegramRequest.ProtoReflect.Descriptor instead.
func (*TryRegistryFromTelegramRequest) Descriptor() ([]byte, []int) {
	return file_account_account_proto_rawDescGZIP(), []int{2}
}

func (x *TryRegistryFromTelegramRequest) GetTgId() int64 {
	if x != nil {
		return x.TgId
	}
	return 0
...
func (x *TryRegistryFromTelegramRequest) GetTgFirstName() string {
	if x != nil {
...
func (x *TryRegistryFromTelegramRequest) GetTgLastName() string {
	if x != nil {
		return x.TgLastName
	}
	return ""
...
func (x *TryRegistryFromTelegramRequest) GetTgUsername() string {
	if x != nil {
		return x.TgUsername
	}
	return ""
...
func (x *TryRegistryFromTelegramRequest) GetTgIsPremium() bool {
	if x != nil {
...
var file_account_account_proto_rawDesc = string([]byte{
	...
	,
	...
	,
...
var file_account_account_proto_goTypes = []any{
	...
	(*TryRegistryFromTelegramRequest)(nil), // 3: users.TryRegistryFromTelegramRequest
...
var file_account_account_proto_depIdxs = []int32{
	...
	3, // 2: users.Users.TryRegistryFromTelegram:input_type -> users.TryRegistryFromTelegramRequest
	1, // 3: users.Users.TryRegistryFromTelegram:output_type -> users.Account
